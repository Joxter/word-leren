...
import rawData from "../data/listening.json";

const data = rawData as ListeningItem[];
const TOTAL = data.length;

const LS_PAGE = "listening-page";
const LS_HISTORY = "listening-history";
...
export function ListeningQuiz() {
  ...
  const audioSrc = `${import.meta.env.BASE_URL}${item.audioFile}`;
  ...
  return (
    ...
    >
      ...
      <div className="audio-controls">
        <span className="audio-controls-label">Speed</span>
